                        ...
                        <form method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative password-container">
                                    <input type="password" name="password" id="password" class="w-full p-3 pr-10 border border-gray-300 text-black rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition"/>
